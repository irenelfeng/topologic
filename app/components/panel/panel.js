  ...
  render() {
    ...
    return (
      <div id="panel">
        ...
        <ListContainer ref={(ref) => this.listContainer = ref} setForm={this.props.setForm} active={this.props.active} filterFn={this.state.filterFn} groups={this.props.items.groups} items={itemsToPass} setForm={this.props.setForm} />
      </div>
    );
  }
}
