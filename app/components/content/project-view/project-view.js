  ...
  */ 
  ...
  render() {
    if (this.props.form[this.props.active] != null)
      return (<FormView object={this.props.form} saveObject={this.props.saveObject} changeForm={this.changeForm.bind(this)} setForm={this.props.setForm} type={this.state.type} />);
